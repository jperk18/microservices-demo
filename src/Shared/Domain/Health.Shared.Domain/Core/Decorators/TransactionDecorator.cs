    ...
    where TCommand : ICommand<TOutput>
{
    ...
    public TransactionCommandDecorator(ILogger<TransactionCommandDecorator<TCommand, TOutput>> logger,IAsyncCommandHandler<TCommand, TOutput> handler, DbContext dbContext)
    {
